...
2. Open the resulting folder and drag `CreateShareableRegionWindow.app` to **Applications**.
3. Open the app from Applications. macOS will display a warning and block this first launch because the free ad-hoc signature is not an Apple Developer ID; **this is expected**.
